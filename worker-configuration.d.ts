/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 072b5e2d06ee9fcdde3f0e9de3a750f4)
// Runtime types generated with workerd@1.20260722.1 2026-07-25 nodejs_compat
interface __BaseEnv_Env {
	DJANGO_DEBUG: "0";
	DJANGO_ALLOWED_HOSTS: "hal.jfix.com,hal-publication-manager.jakob-fix.workers.dev";
	DJANGO_CSRF_TRUSTED_ORIGINS: "https://hal.jfix.com,https://hal-publication-manager.jakob-fix.workers.dev";
	R2_BUCKET_NAME: "hal-publication-snapshots";
	OPENAI_MODEL: "gpt-5.6-terra";
	SUMMARY_USER_MINUTE_LIMIT: "3";
	SUMMARY_USER_DAILY_LIMIT: "20";
	SUMMARY_GLOBAL_DAILY_LIMIT: "100";
	SUMMARY_CACHE_RETENTION_DAYS: "90";
	DJANGO_CONTAINER: DurableObjectNamespace<import("./worker/index").DjangoContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "DjangoContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DJANGO_DEBUG" | "DJANGO_ALLOWED_HOSTS" | "DJANGO_CSRF_TRUSTED_ORIGINS" | "R2_BUCKET_NAME" | "OPENAI_MODEL" | "SUMMARY_USER_MINUTE_LIMIT" | "SUMMARY_USER_DAILY_LIMIT" | "SUMMARY_GLOBAL_DAILY_LIMIT" | "SUMMARY_CACHE_RETENTION_DAYS">> {}
}
